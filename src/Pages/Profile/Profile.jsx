...
import { getUsersReelsAction } from "../../Redux/Reels/Reels.action";
const tabs = [
...
const Profile = () => {
  ...
  const { post,reels } = useSelector((store) => store);
        ...
        <div className="p-5">
          <div>
            <h1 className="font-bold py-1 text-xl">
              {auth.user?.firstName + " " + auth.user?.lirstName}
            </h1>
            <p>
              @
              {auth.user?.firstName.toLowerCase() +
                "_" +
                auth.user?.lirstName.toLowerCase()}
            </p>
          </div>
        ...
        <section>
          ...
          <div className="flex  justify-center ">
            {value === "post" ? (
              ...
              <div className=" w-[50%] my-10  space-y-5  ">
